...
function Home() {
  return (
    <>
     {/* banner section */}
      ...
      <section className="cs_hero_1-wrap position-relative cs_hero_slider bg-primary" >
        <div className="cs_swiper_parallax_slider_wrap">
          <div className="cs_parallax_slider loading">
            <div className="swiper-wrapper">
              <div className="swiper-slide">
                <div className="cs_hero cs_style_1 d-flex align-items-center justify-content-center background-filled position-relative overflow-hidden">
                  <figure className="cs_swiper_parallax_bg" data-src="assets/img/hero_slider_1.jpeg">
                    <img src="assets/img/hero_slider_1.jpeg" alt="Slider" className="cs_entity_img" />
                  ...
                  <div className="container">
                    <div className="cs_hero_text position-relative cs_zindex_5 d-inline-block">
                      <h2 className="text-white cs_mb_5 fw-normal cs_fs_18">This Week Only for World Premier</h2>
                      <h1 className="text-white cs_mb_16 cs_fs_60 cs_fs_lg_46">
                        Inventive and interested <br />in innovation
                      </h1>
                      <p className="text-white cs_mb_20">
                      ...
                      <div className="cs_hero_btn">
                        <a href="contact.html" className="cs_btn cs_style_1 cs_fs_14 cs_rounded_5 cs_pl_30 cs_pr_30 cs_pt_10 cs_pb_10 overflow-hidden"><span>Get A Quote</span></a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="swiper-slide">
                <div className="cs_hero cs_style_1 d-flex align-items-center justify-content-center background-filled position-relative overflow-hidden">
                  <figure className="cs_swiper_parallax_bg" data-src="assets/img/hero_slider_2.jpeg">
                    <img src="assets/img/hero_slider_2.jpeg" alt="Slider" className="cs_entity_img" />
                    <div className="bg-primary opacity-75 position-absolute w-100 h-100 start-0 top-0" />
                  </figure>
                  <div className="container">
                    <div className="cs_hero_text position-relative cs_zindex_5 d-inline-block">
              ...
              <div className="swiper-slide">
                <div className="cs_hero cs_style_1 d-flex align-items-center justify-content-center background-filled position-relative overflow-hidden">
                  <figure className="cs_swiper_parallax_bg" data-src="assets/img/hero_slider_3.jpeg">
                    <img src="assets/img/hero_slider_3.jpeg" alt="Slider" className="cs_entity_img" />
                    <div className="bg-primary opacity-75 position-absolute w-100 h-100 start-0 top-0" />
                  </figure>
                  <div className="container">
                    <div className="cs_hero_text position-relative cs_zindex_5 d-inline-block">
            ...
            <div className="cs_slider_navigation d-flex cs_row_gap_15 flex-column position-absolute
          cs_zindex_4">
              <div className="cs_swiper_button_prev filter cs_height_45 cs_width_45 bg-white rounded-circle d-flex align-items-center justify-content-center bg-accent-hover cs_transition_4">
              ...
              <div className="cs_swiper_button_next filter cs_height_45 cs_width_45 bg-white rounded-circle d-flex align-items-center justify-content-center bg-accent-hover cs_transition_4">
                <svg width={20} height={8} viewBox="0 0 20 8" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <svg width={434} height={759} viewBox="0 0 434 759" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <defs>
                  <linearGradient id="paint0_linear_81_287" x1={145} y1="256.5" x2={484} y2={738} gradientUnits="userSpaceOnUse">
                    ...
                    <stop offset={1} stopColor="#E9A132" />
                  </linearGradient>
                </defs>
              </svg>            
            </div>
            <div className="cs_hero_shape_2 position-absolute start-0 cs_zindex_1">
              <svg width={572} height={572} viewBox="0 0 572 572" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M572 -6.10352e-05L6.10352e-05 572L1.10293e-05 -1.10293e-05L572 -6.10352e-05Z" fill="url(#paint0_linear_81_258)" fillOpacity="0.7" />
                <defs>
                  <linearGradient id="paint0_linear_81_258" x1="388.254" y1="307.69" x2="-127.973" y2="-227.83" gradientUnits="userSpaceOnUse">
                    ...
                    <stop offset="0.514455" stopColor="#FEC63F" stopOpacity="0.35" />
                  </linearGradient>
                </defs>
              </svg>            
            </div>
        ...
        <div className="cs_social_btns d-flex flex-column cs_column_gap_15 cs_row_gap_15 cs_transition_5 position-absolute cs_zindex_5 ">
      ...
      <div className="cs_moving_wrap background-filled text-uppercase text-white d-flex align-items-center" data-src="assets/img/moving_text_shape.png">
    ...
    {/* ============================ */}
      ...
      <section className="background-filled cs_pt_133 cs_pt_lg_75 cs_pb_140 cs_pb_lg_80" data-src="assets/img/services_bg.jpeg">
        <div className="container">
          <div className="cs_section_heading cs_style_1 d-flex align-items-center cs_mb_60 cs_mb_lg_40 cs_column_gap_15 cs_row_gap_15">
            <div className="cs_section_heading_in">
              <h3 className="cs_fs_20 cs_fs_lg_18 text-accent fw-normal cs_lh_base cs_mb_10 wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s">Our Service List</h3>
              <h2 className="cs_fs_48 cs_fs_lg_36 m-0">We Provide The Solution <br />For Our Clients</h2>
            </div>
            <div className="cs_section_heading_right">
              <p className="cs_section_text m-0">I have been a loyal customer of this auto parts company for years and I cannot recommend them enough. Their extensive selection of high-quality parts and accessories.</p>
            </div>
          </div>
          <div className="row">
            <div className="col-xl-3 col-md-6">
              <div className="cs_service cs_style_1 cs_pt_25 cs_pl_25 cs_pr_25 cs_pb_15 bg-white cs_transition_4 shadow cs_mb_25">
                <div className="cs_service_iconbox d-flex align-items-center cs_mb_20">
                  ...
                  <h2 className="cs_lh_base cs_fs_20 cs_fs_lg_18 m-0"><a href="services-details.html" className="inline-block">Accounting and Bookkeeping</a></h2>
                </div>
                <p className="cs_mb_24">Services related to financial record-keeping, bookkeeping, preparation.</p>
                <div className="cs_service_thumb position-relative cs_rounded_5">
                  <a href="services-details.html" className="cs_service_btn d-flex align-items-center justify-content-center rounded-circle position-absolute text-white">
                  ...
                  <div className="cs_service_thumb-in position-relative-in background-filled h-100" data-src="assets/img/service_1.jpeg" />
                </div>
              </div>
            </div>
            <div className="col-xl-3 col-md-6">
              <div className="cs_service cs_style_1 cs_pt_25 cs_pl_25 cs_pr_25 cs_pb_15 bg-white cs_transition_4 shadow cs_mb_25">
                <div className="cs_service_iconbox d-flex align-items-center cs_mb_20">
                  ...
                  <h2 className="cs_lh_base cs_fs_20 cs_fs_lg_18 m-0"><a href="services-details.html" className="inline-block">IT Support and Consulting</a></h2>
                </div>
                <p className="cs_mb_24">Providing technical support, network setup, software installation.</p>
                <div className="cs_service_thumb position-relative cs_rounded_5">
                  <a href="services-details.html" className="cs_service_btn d-flex align-items-center justify-content-center rounded-circle position-absolute text-white">
                    <svg width={22} height={22} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M20.8491 11.347C20.855 11.3381 20.8602 11.3289 20.8656 11.3198C20.8706 11.3114 20.8759 11.3032 20.8805 11.2946C20.8855 11.2853 20.8897 11.2757 20.8942 11.2663C20.8984 11.2573 20.9029 11.2484 20.9067 11.2392C20.9105 11.23 20.9136 11.2206 20.9169 11.2113C20.9205 11.2014 20.9243 11.1916 20.9274 11.1814C20.9302 11.1721 20.9322 11.1626 20.9346 11.1532C20.9372 11.1429 20.9401 11.1327 20.9422 11.1222C20.9444 11.1113 20.9456 11.1003 20.9472 11.0894C20.9485 11.0801 20.9503 11.0711 20.9512 11.0617C20.9532 11.0415 20.9543 11.0213 20.9543 11.001C20.9543 11.0007 20.9543 11.0004 20.9543 11.0001C20.9543 10.9998 20.9543 10.9994 20.9543 10.9991C20.9542 10.9789 20.9532 10.9586 20.9512 10.9384C20.9503 10.929 20.9485 10.92 20.9472 10.9108C20.9456 10.8998 20.9444 10.8888 20.9422 10.8779C20.9401 10.8674 20.9372 10.8572 20.9346 10.8469C20.9322 10.8375 20.9302 10.828 20.9274 10.8187C20.9243 10.8086 20.9205 10.7988 20.9169 10.7889C20.9136 10.7795 20.9105 10.7701 20.9067 10.7609C20.9029 10.7517 20.8984 10.7428 20.8941 10.7338C20.8897 10.7244 20.8855 10.7148 20.8805 10.7055C20.8759 10.6969 20.8706 10.6887 20.8656 10.6803C20.8602 10.6712 20.855 10.662 20.8491 10.6531C20.8428 10.6438 20.8359 10.635 20.8292 10.6261C20.8237 10.6187 20.8186 10.6112 20.8127 10.604C20.7996 10.588 20.7858 10.5727 20.7713 10.5581L15.026 4.81285C14.7819 4.56877 14.3862 4.56877 14.1421 4.81285C13.898 5.05692 13.898 5.45264 14.1421 5.69672L18.8204 10.375L0.88388 10.375C0.53871 10.375 0.258878 10.6548 0.258878 11C0.258878 11.3452 0.53871 11.625 0.88388 11.625L18.8204 11.625L14.1421 16.3033C13.8981 16.5474 13.8981 16.9431 14.1421 17.1872C14.3862 17.4312 14.7819 17.4313 15.026 17.1872L20.7713 11.442C20.7858 11.4274 20.7996 11.4121 20.8127 11.3962C20.8186 11.389 20.8237 11.3814 20.8292 11.374C20.8359 11.3651 20.8428 11.3563 20.8491 11.347Z" fill="currentColor" />
                  ...
                  <div className="cs_service_thumb-in position-relative-in background-filled h-100" data-src="assets/img/service_2.jpeg" />
                </div>
              </div>
            </div>
            <div className="col-xl-3 col-md-6">
              <div className="cs_service cs_style_1 cs_pt_25 cs_pl_25 cs_pr_25 cs_pb_15 bg-white cs_transition_4 shadow cs_mb_25">
                <div className="cs_service_iconbox d-flex align-items-center cs_mb_20">
                  ...
                  <h2 className="cs_lh_base cs_fs_20 cs_fs_lg_18 m-0"><a href="services-details.html" className="inline-block">Marketing and Advertising</a></h2>
                </div>
                <p className="cs_mb_24">Services that help businesses create and execute market strategies.</p>
                <div className="cs_service_thumb position-relative cs_rounded_5">
                  <a href="services-details.html" className="cs_service_btn d-flex align-items-center justify-content-center rounded-circle position-absolute text-white">
                    <svg width={22} height={22} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M20.8491 11.347C20.855 11.3381 20.8602 11.3289 20.8656 11.3198C20.8706 11.3114 20.8759 11.3032 20.8805 11.2946C20.8855 11.2853 20.8897 11.2757 20.8942 11.2663C20.8984 11.2573 20.9029 11.2484 20.9067 11.2392C20.9105 11.23 20.9136 11.2206 20.9169 11.2113C20.9205 11.2014 20.9243 11.1916 20.9274 11.1814C20.9302 11.1721 20.9322 11.1626 20.9346 11.1532C20.9372 11.1429 20.9401 11.1327 20.9422 11.1222C20.9444 11.1113 20.9456 11.1003 20.9472 11.0894C20.9485 11.0801 20.9503 11.0711 20.9512 11.0617C20.9532 11.0415 20.9543 11.0213 20.9543 11.001C20.9543 11.0007 20.9543 11.0004 20.9543 11.0001C20.9543 10.9998 20.9543 10.9994 20.9543 10.9991C20.9542 10.9789 20.9532 10.9586 20.9512 10.9384C20.9503 10.929 20.9485 10.92 20.9472 10.9108C20.9456 10.8998 20.9444 10.8888 20.9422 10.8779C20.9401 10.8674 20.9372 10.8572 20.9346 10.8469C20.9322 10.8375 20.9302 10.828 20.9274 10.8187C20.9243 10.8086 20.9205 10.7988 20.9169 10.7889C20.9136 10.7795 20.9105 10.7701 20.9067 10.7609C20.9029 10.7517 20.8984 10.7428 20.8941 10.7338C20.8897 10.7244 20.8855 10.7148 20.8805 10.7055C20.8759 10.6969 20.8706 10.6887 20.8656 10.6803C20.8602 10.6712 20.855 10.662 20.8491 10.6531C20.8428 10.6438 20.8359 10.635 20.8292 10.6261C20.8237 10.6187 20.8186 10.6112 20.8127 10.604C20.7996 10.588 20.7858 10.5727 20.7713 10.5581L15.026 4.81285C14.7819 4.56877 14.3862 4.56877 14.1421 4.81285C13.898 5.05692 13.898 5.45264 14.1421 5.69672L18.8204 10.375L0.88388 10.375C0.53871 10.375 0.258878 10.6548 0.258878 11C0.258878 11.3452 0.53871 11.625 0.88388 11.625L18.8204 11.625L14.1421 16.3033C13.8981 16.5474 13.8981 16.9431 14.1421 17.1872C14.3862 17.4312 14.7819 17.4313 15.026 17.1872L20.7713 11.442C20.7858 11.4274 20.7996 11.4121 20.8127 11.3962C20.8186 11.389 20.8237 11.3814 20.8292 11.374C20.8359 11.3651 20.8428 11.3563 20.8491 11.347Z" fill="currentColor" />
                  ...
                  <div className="cs_service_thumb-in position-relative-in background-filled h-100" data-src="assets/img/service_3.jpeg" />
                </div>
              </div>
            </div>
            <div className="col-xl-3 col-md-6">
              <div className="cs_service cs_style_1 cs_pt_25 cs_pl_25 cs_pr_25 cs_pb_15 bg-white cs_transition_4 shadow cs_mb_25">
                <div className="cs_service_iconbox d-flex align-items-center cs_mb_20">
                  ...
                  <h2 className="cs_lh_base cs_fs_20 cs_fs_lg_18 m-0"><a href="services-details.html" className="inline-block">Human Resources</a></h2>
                </div>
                <p className="cs_mb_24">Assistance with HR-related tasks such as recruitment, training, performance.</p>
                <div className="cs_service_thumb position-relative cs_rounded_5">
                  <a href="services-details.html" className="cs_service_btn d-flex align-items-center justify-content-center rounded-circle position-absolute text-white">
                    <svg width={22} height={22} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M20.8491 11.347C20.855 11.3381 20.8602 11.3289 20.8656 11.3198C20.8706 11.3114 20.8759 11.3032 20.8805 11.2946C20.8855 11.2853 20.8897 11.2757 20.8942 11.2663C20.8984 11.2573 20.9029 11.2484 20.9067 11.2392C20.9105 11.23 20.9136 11.2206 20.9169 11.2113C20.9205 11.2014 20.9243 11.1916 20.9274 11.1814C20.9302 11.1721 20.9322 11.1626 20.9346 11.1532C20.9372 11.1429 20.9401 11.1327 20.9422 11.1222C20.9444 11.1113 20.9456 11.1003 20.9472 11.0894C20.9485 11.0801 20.9503 11.0711 20.9512 11.0617C20.9532 11.0415 20.9543 11.0213 20.9543 11.001C20.9543 11.0007 20.9543 11.0004 20.9543 11.0001C20.9543 10.9998 20.9543 10.9994 20.9543 10.9991C20.9542 10.9789 20.9532 10.9586 20.9512 10.9384C20.9503 10.929 20.9485 10.92 20.9472 10.9108C20.9456 10.8998 20.9444 10.8888 20.9422 10.8779C20.9401 10.8674 20.9372 10.8572 20.9346 10.8469C20.9322 10.8375 20.9302 10.828 20.9274 10.8187C20.9243 10.8086 20.9205 10.7988 20.9169 10.7889C20.9136 10.7795 20.9105 10.7701 20.9067 10.7609C20.9029 10.7517 20.8984 10.7428 20.8941 10.7338C20.8897 10.7244 20.8855 10.7148 20.8805 10.7055C20.8759 10.6969 20.8706 10.6887 20.8656 10.6803C20.8602 10.6712 20.855 10.662 20.8491 10.6531C20.8428 10.6438 20.8359 10.635 20.8292 10.6261C20.8237 10.6187 20.8186 10.6112 20.8127 10.604C20.7996 10.588 20.7858 10.5727 20.7713 10.5581L15.026 4.81285C14.7819 4.56877 14.3862 4.56877 14.1421 4.81285C13.898 5.05692 13.898 5.45264 14.1421 5.69672L18.8204 10.375L0.88388 10.375C0.53871 10.375 0.258878 10.6548 0.258878 11C0.258878 11.3452 0.53871 11.625 0.88388 11.625L18.8204 11.625L14.1421 16.3033C13.8981 16.5474 13.8981 16.9431 14.1421 17.1872C14.3862 17.4312 14.7819 17.4313 15.026 17.1872L20.7713 11.442C20.7858 11.4274 20.7996 11.4121 20.8127 11.3962C20.8186 11.389 20.8237 11.3814 20.8292 11.374C20.8359 11.3651 20.8428 11.3563 20.8491 11.347Z" fill="currentColor" />
                  ...
                  <div className="cs_service_thumb-in position-relative-in background-filled h-100" data-src="assets/img/service_4.jpeg" />
                </div>
              </div>
            </div>
          </div>
          <div className="cs_service_1-info  text-center cs_mt_40 d-flex justify-content-center align-items-center flex-wrap">
            <h4 className="fw-normal m-0">Digital agency services built specifically for your business</h4>
            <a href="service.html" className="cs_btn cs_style_1 cs_fs_14  overflow-hidden cs_fs_16 cs_rounded_25 cs_pl_20 cs_pr_20 cs_pt_7 cs_pb_7 wow zoomIn" data-wow-duration="0.8s" data-wow-delay="0.2s"><span>Find More Services</span></a>
          </div>
        </div>
      </section>
  {/* ========================= */}
  
      <section className="cs_pt_135 cs_pt_lg_75 cs_pb_140 cs_pb_lg_80 position-relative">
        <div className="container">
          <div className="row">
              ...
              <div className="cs_experience cs_style_1 position-relative">
                ...
                <div className="cs_experience_box background-filled text-center bg-white cs_rounded_10 position-absolute bottom-0 end-0 cs_zindex_3 d-flex flex-column justify-content-center align-items-center" data-src="assets/img/experience_bg.jpeg" >
                  ...
                  <h3 className="text-white cs_fs_60 cs_fs_lg_46 fw-bold lh_1 mb-0 d-flex justify-content-between">
                    <span data-count-to={40} className="odometer" />
              ...
              <div className="cs_about cs_style_1">
                ...
                <div className="cs_progressbar cs_style_1 cs_mb_20">
                  ...
                  <div className="cs_progress cs_rounded_8 overflow-hidden" data-progress={90}>
                    <div className="cs_progress_in bg-accent cs_rounded_8 h-100 wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s" />
                  </div>
                </div>{/* .cs_progressbar */}
                <div className="row cs_mb_15">
                  <div className="col-lg-6">
                    <div className="cs_about-icon-box position-relative cs_mb_25">
                      <span className="position-absolute cs_height_20 cs_width_20 top-0 start-0 cs_mt_5 bg-accent text-white cs_fs_10 d-flex align-items-center justify-content-center cs_rounded_30"><i className="fa-solid fa-angles-right" /></span>
                ...
                <div className="d-flex align-items-center cs_row_gap_20 cs_column_gap_30 cs_column_gap_lg_20 flex-wrap">
                  <a href="contact.html" className="cs_btn cs_style_1 cs_fs_14 cs_rounded_5 cs_pl_30 cs_pr_30 cs_pt_10 cs_pb_10 overflow-hidden"><span>Get A Quote</span></a>
                  <a href="https://www.youtube.com/embed/VStvZjykQ00" className="cs_video_open d-flex align-items-center">
                    ...
                    <span className="cs_ml_15">Watch the video</span>               
                  </a>
                </div>
              </div>
            </div>
   ...
   {/* =========================== */}
      ...
      <section className="cs_pb_115 cs_pb_lg_55">
        <div className="container">
          <div className="cs_section_heading cs_style_1 d-flex align-items-center text-center cs_mb_60 cs_mb_lg_40">
            <div className="cs_section_heading_in">
              <h3 className="cs_fs_20 cs_fs_lg_18 text-accent fw-normal cs_lh_base cs_mb_10 wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">Meet Our Team Member</h3>
              <h2 className="cs_fs_48 cs_fs_lg_36 m-0">Meet the professional team <br />behind the success</h2>
            </div>
          </div>
          <div className="row">
            <div className="col-lg-4">
              <div className="cs_team cs_style_1 text-center cs_mb_25 overflow-hidden cs_rounded_50">
                <div className="cs_team_member position-relative cs_rounded_50">
                  <img className="w-100 cs_rounded_50" src="assets/img/team_member_1.jpeg" alt="Member" />
                  <div className="cs_social_btns d-flex flex-wrap cs_column_gap_15 cs_row_gap_15 cs_transition_5 cs_fs_20 cs_fs_lg_18 position-absolute">
                    <a href="#" className="d-flex align-items-center justify-content-center cs_height_45 cs_width_45 border-0 text-white rounded-circle"><i className="fa-brands fa-facebook-f" /></a>
                    <a href="#" className="d-flex align-items-center justify-content-center cs_height_45 cs_width_45 border-0 text-white rounded-circle"><i className="fa-brands fa-twitter" /></a>
                    <a href="#" className="d-flex align-items-center justify-content-center cs_height_45 cs_width_45 border-0 text-white rounded-circle"><i className="fa-brands fa-dribbble" /></a>
                  </div>
                </div>
                <div className="cs_team_info cs_pt_127 cs_pl_15 cs_pr_15 cs_pb_25 cs_transition_4">
                  <h2 className="text-white m-0 cs_fs_26 cs_mb_3">Ralph Edwards</h2>
                  <p className="text-white m-0">Web designer</p>
                </div>
              </div>
            </div>
            <div className="col-lg-4">
              <div className="cs_team cs_style_1 text-center cs_mb_25 overflow-hidden cs_rounded_50">
                <div className="cs_team_member position-relative cs_rounded_50">
                  <img className="w-100 cs_rounded_50" src="assets/img/team_member_2.jpeg" alt="Member" />
                  <div className="cs_social_btns d-flex flex-wrap cs_column_gap_15 cs_row_gap_15 cs_transition_5 cs_fs_20 cs_fs_lg_18 position-absolute">
                    <a href="#" className="d-flex align-items-center justify-content-center cs_height_45 cs_width_45 border-0 text-white rounded-circle"><i className="fa-brands fa-facebook-f" /></a>
                    <a href="#" className="d-flex align-items-center justify-content-center cs_height_45 cs_width_45 border-0 text-white rounded-circle"><i className="fa-brands fa-twitter" /></a>
                    <a href="#" className="d-flex align-items-center justify-content-center cs_height_45 cs_width_45 border-0 text-white rounded-circle"><i className="fa-brands fa-dribbble" /></a>
                ...
                <div className="cs_team_info cs_pt_127 cs_pl_15 cs_pr_15 cs_pb_25 cs_transition_4">
                  <h2 className="text-white m-0 cs_fs_26 cs_mb_3">Wade Warren</h2>
                  <p className="text-white m-0">Marketing Coordinator</p>
                </div>
              </div>
            </div>
            <div className="col-lg-4">
              <div className="cs_team cs_style_1 text-center cs_mb_25 overflow-hidden cs_rounded_50">
                <div className="cs_team_member position-relative cs_rounded_50">
                  <img className="w-100 cs_rounded_50" src="assets/img/team_member_3.jpeg" alt="Member" />
                  <div className="cs_social_btns d-flex flex-wrap cs_column_gap_15 cs_row_gap_15 cs_transition_5 cs_fs_20 cs_fs_lg_18 position-absolute">
                    <a href="#" className="d-flex align-items-center justify-content-center cs_height_45 cs_width_45 border-0 text-white rounded-circle"><i className="fa-brands fa-facebook-f" /></a>
                    <a href="#" className="d-flex align-items-center justify-content-center cs_height_45 cs_width_45 border-0 text-white rounded-circle"><i className="fa-brands fa-twitter" /></a>
                    <a href="#" className="d-flex align-items-center justify-content-center cs_height_45 cs_width_45 border-0 text-white rounded-circle"><i className="fa-brands fa-dribbble" /></a>
                ...
                <div className="cs_team_info cs_pt_127 cs_pl_15 cs_pr_15 cs_pb_25 cs_transition_4">
                  <h2 className="text-white m-0 cs_fs_26 cs_mb_3">Jane Cooper</h2>
                  <p className="text-white m-0">Creative Designer</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="background-filled overflow-hidden cs_pt_133 cs_pt_lg_75 cs_pb_140 cs_pb_lg_80" data-src="assets/img/cta_bg.jpeg" style={{ backgroundImage: `url(assets/img/cta_bg.jpeg)` }}>
        <div className="container">
          <div className="row align-items-center">
            <div className="col-xl-5 col-lg-6">
              <div className="cs_section_heading cs_style_1 d-flex align-items-center cs_mb_40">
                <div className="cs_section_heading_in">
                  <h3 className="cs_fs_20 cs_fs_lg_18 text-accent fw-normal cs_lh_base cs_mb_10 wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s">Contact With Us</h3>
                  <h2 className="cs_fs_48 cs_fs_lg_36 cs_mb_20 text-white">Let’s Work Together?</h2>
                  <p className="text-white m-0">Providing legal advice, contract drafting, compliance assistance, intellectual property protection, and other legal support for businesses.</p>
                </div>
              </div>
              <div className="d-flex align-items-center cs_mb_30">
                ...
                <div>
                  ...
                  <h2 className="text-white m-0 fw-medium cs_fs_22 cs_fs_lg_18 cs_lh_base">+ 070 4531 9507 </h2>
                </div>
              </div>
              <div className="d-flex align-items-center cs_mb_30">
                <div className="d-flex align-items-center justify-content-center cs_height_90 cs_width_90 cs_height_lg_80 cs_width_lg-80 cs_rounded_10 flex-none cs_mr_20 bg-accent">
                ...
                <div>
                  ...
                  <h2 className="text-white m-0 fw-medium cs_fs_22 cs_fs_lg_18 cs_lh_base">bizmax@laralink.com</h2>
                </div>
              </div>
              <div className="d-flex align-items-center">
                ...
                <div>
                  ...
                  <h2 className="text-white m-0 fw-medium cs_fs_22 cs_fs_lg_18 cs_lh_base">Yewtree Cottage, Kings Pyon, <br />HR4 8PZ</h2>
                </div>
              </div>
            </div>
            <div className="col-xl-5 col-lg-6 offset-xl-1 cs_mt_lg_55">
              <div className="cs_contact_wrap position-relative">
                <form action="#" className="cs_contact_form bg-white cs_pt_64 cs_pl_80 cs_pr_80 cs_pb_80 cs_pl_lg_30 cs_pr_lg_30 position-relative cs_rounded_20" data-src="assets/img/contact_bg_pattern.svg">
                  ...
                  <input className="form-control cs_fs_14 cs_rounded_5 border-0 cs_mb_15 bg-gray" type="text" placeholder="Your Name" />
                  <input className="form-control cs_fs_14 cs_rounded_5 border-0 cs_mb_15 bg-gray" type="email" placeholder="Your Email" />
                  <textarea className="form-control cs_fs_14 cs_rounded_5 border-0 cs_mb_30 bg-gray" placeholder="Message here ..." cols={30} rows={4} defaultValue={""} />
                  <button className="cs_btn cs_style_1 cs_fs_14 cs_rounded_5 cs_pl_30 cs_pr_30 cs_pt_10 cs_pb_10 overflow-hidden"><span>Submit Now</span></button>
                </form>
                <div className="cs_contact_image d-none d-xl-block wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.4s"><img src="assets/img/contact_img_11.png" alt="" /></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="cs_pt_115 cs_pt_lg_75 cs_pb_110 cs_pb_lg_50">
        <div className="container">
          <div className="cs_section_heading cs_style_1 d-flex align-items-center text-center cs_mb_60 cs_mb_lg_40">
            <div className="cs_section_heading_in">
              <h3 className="cs_fs_20 cs_fs_lg_18 text-accent fw-normal cs_lh_base cs_mb_10 wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">Find The Blogs</h3>
              <h2 className="cs_fs_48 cs_fs_lg_36 m-0">Find Out Latest News <br />and Articles</h2>
            </div>
          </div>
          <div className="row">
            <div className="col-lg-4">
              <div className="cs_post cs_style_1 bg-white shadow-sm cs_mb_30">
                <a href="blog-details.html" className="cs_post_thumb d-block position-relative overflow-hidden">
                  <div className="cs_post_thumb-in cs_transition_5 background-filled h-100 w-100" data-src="assets/img/post_1.jpeg" />
                </a>
                <div className="cs_post_in">
                  <div className="cs_post_info cs_pl_33 cs_pr_33 cs_pt_40 cs_pb_40">
                    <ul className="cs_post_meta d-flex flex-wrap cs_fs_12 p-0 cs_mb_16">
                      <li>
                        <span><i className="fa-solid fa-user" /> By </span> 
                        <a href>admin</a>
                      </li>
                      <li>
                        <span><i className="fa-solid fa-comment-dots" /></span> 
                        <a href>3 comments</a>
                      </li>
                    </ul>
                    <h2 className="cs_post_title cs_lh_base cs_fs_20 cs_fs_lg_18 cs_mb_10"><a href="blog-details.html">What services does your business provide?</a></h2>
                    <div className="cs_post_subtitle">We provide a range of digital marketing lutions including website design.</div>
                  </div>
                  <a href="blog-details.html" className="cs_post_btn d-flex justify-content-between align-items-center cs_pl_40 cs_pr_40 cs_pb_10 cs_pt_10">
            ...
            <div className="col-lg-4">
              <div className="cs_post cs_style_1 bg-white shadow-sm cs_mb_30">
                <a href="blog-details.html" className="cs_post_thumb d-block position-relative overflow-hidden">
                  <div className="cs_post_thumb-in cs_transition_5 background-filled h-100 w-100" data-src="assets/img/post_2.jpeg" />
                </a>
                <div className="cs_post_in">
                  <div className="cs_post_info cs_pl_33 cs_pr_33 cs_pt_40 cs_pb_40">
                    <ul className="cs_post_meta d-flex flex-wrap cs_fs_12 p-0 cs_mb_16">
                    ...
                    <h2 className="cs_post_title cs_lh_base cs_fs_20 cs_fs_lg_18 cs_mb_10"><a href="blog-details.html">Introducing the latest tech features for you</a></h2>
                    <div className="cs_post_subtitle">We provide a range of digital marketing lutions including website design.</div>
                  </div>
                  <a href="blog-details.html" className="cs_post_btn d-flex justify-content-between align-items-center cs_pl_40 cs_pr_40 cs_pb_10 cs_pt_10">
                    <span className="cs_post_btn-text">Read More</span>
            ...
            <div className="col-lg-4">
              <div className="cs_post cs_style_1 bg-white shadow-sm cs_mb_30">
                <a href="blog-details.html" className="cs_post_thumb d-block position-relative overflow-hidden">
                  <div className="cs_post_thumb-in cs_transition_5 background-filled h-100 w-100" data-src="assets/img/post_3.jpeg" />
                </a>
                <div className="cs_post_in">
                  <div className="cs_post_info cs_pl_33 cs_pr_33 cs_pt_40 cs_pb_40">
                    <ul className="cs_post_meta d-flex flex-wrap cs_fs_12 p-0 cs_mb_16">
                    ...
                    <h2 className="cs_post_title cs_lh_base cs_fs_20 cs_fs_lg_18 cs_mb_10"><a href="blog-details.html">The creative studio programm coming soon</a></h2>
                    <div className="cs_post_subtitle">We provide a range of digital marketing lutions including website design.</div>
                  </div>
                  <a href="blog-details.html" className="cs_post_btn d-flex justify-content-between align-items-center cs_pl_40 cs_pr_40 cs_pb_10 cs_pt_10">
                    <span className="cs_post_btn-text">Read More</span>
